...
* `resnet-50-tf`
* `vgg19`
* all other classification models (check the `models.lst` file in the demo's directory)
...
Please note that you should use `imagenet_2015_classes.txt` labels file located in the demo's directory with the following models:
- googlenet-v2
- se-inception
- se-resnet-101
- se-resnet-152
...
and `imagenet_2012_classes.txt` labels file with all other models supported by the demo.
