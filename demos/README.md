...
You can download the [pre-trained models](../models/intel/index.md) using the OpenVINO [Model Downloader](../tools/downloader/README.md) or from [Intel® Open Source Technology Center](https://download.01.org/opencv/).
