# Image Segmentation (asynchronous) C++ Demo {#omz_demos_segmentation_demo_async_README}

This topic demonstrates how to run the Image Segmentation demo application, which does inference using semantic segmentation networks asynchronously.
...
```
./segmentation_demo_async -h
[ INFO ] InferenceEngine: <version>
[ INFO ] Parsing input parameters

segmentation_demo_async [OPTION]
Options:
...
```sh
./segmentation_demo_async -i 0 -m semantic-segmentation-adas-0001.xml
```
