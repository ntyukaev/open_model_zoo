# resnet-50-tf {#omz_models_public_resnet_50_tf_resnet_50_tf}
...
A copy of the license is provided in [APACHE-2.0-TensorFlow.txt](https://github.com/openvinotoolkit/open_model_zoo/blob/master/models/public/licenses/APACHE-2.0-TensorFlow.txt).
